  ...
  <div class="container kanban">
    ...
    <el-row :gutter="10" class="kanban-box">
      ...
      <el-col :span="18" class="flex flex-direction">
        <div class="flex flex-twice margin-tb-xs"></div>
        <div class="flex flex-sub">
          ...
          <div class="kanban-item bgBlack">
            ...
            <el-table :data="unitData" class="kanban-table">
              <el-table-column prop="content" label="单位名称" align="center"></el-table-column>
              <el-table-column prop="content" label="隐患数量" align="center"></el-table-column>
            </el-table>
          </div>
        </div>
      </el-col>
