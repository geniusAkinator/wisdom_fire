  ...
  <div style="width:100%;height:100%;position: relative;">
    <div class="map-cover">
      <div class="fl padding-xs">
        ...
        <count-to :start-val="0" :end-val="chartData.factoryCount" :duration="2600" class="card-panel-num" />
      </div>
      <div class="fl padding-xs">
        <div class="my-count">注册设备数量</div>
        <count-to :start-val="0" :end-val="chartData.transducerCount" :duration="2600" class="card-panel-num" />
      </div>
    </div>
  ...
  methods: {
    ...
    convertData(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        let _arr = [];
        _arr.push(data[i].longitude);
        _arr.push(data[i].latitude);
        res.push({
    ...
    initData() {
      ...
      var data = _this.chartData.chinaList;
      _this.option = {
        animation: true, //过度动画
            ...
            tooltip: {
              ...
              formatter: function(params) {
                ...
                tipHtml =
                  ...
                  data[params.dataIndex].factoryName +
                  "</span>" +
                  "</div>" +
                  ...
                  "故障：" +
                  data[params.dataIndex].sensorFaultCount +
                  "</span>" +
                  '<span style="margin:0 6px;">' +
                  "隐患：" +
                  data[params.dataIndex].hiddenDangerCount +
                  "</span></p>" +
                  "</div>" +
                  "</div>";
